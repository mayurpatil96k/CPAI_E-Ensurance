    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editEmployeeModalLabel">Edit Agent</h5>
...
export default defineComponent({
  props: {
    customer: {
      type: Object as () => {name: string, username: string, email: string, password?: string;phone?:string, password_confirmation?: string; id?: number},
      required: true
    },
    isDialogOpen: {
      type: Boolean,
